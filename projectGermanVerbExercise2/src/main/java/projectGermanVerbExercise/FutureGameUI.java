 ...
 */
// Future tense
public class FutureGameUI extends AbstractVerbGameUI {

    public FutureGameUI() {
        super("German Verb Exercise - Future Tense");
    }
    
    
    @Override
    protected String getCSVFilePath() {
        return "csv/verbs_future.csv";
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FutureGameUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new FutureGameUI().setVisible(true);
