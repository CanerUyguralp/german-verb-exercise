...
public class PresentPerfectGameUI extends AbstractVerbGameUI {

    public PresentPerfectGameUI() {
        super("German Verb Exercise - Present Perfect Tense");
    }

    @Override
    protected String getCSVFilePath() {
        return "csv/verbsPresentPerfect.csv";
    }
    ...
    protected void askQuestion() {
        ...
        if (currentPersonIndex < persons.length) {
            ...
            try {
                ...
                doc.insertString(doc.getLength(), "Partizip 2: ", tenseStyle);
                ...
                //Append the text for Hilfsverb
                //doc.insertString(doc.getLength(), " mit dem passenden Hilfsverb(haben/sein) ", null);
                // Append the rest of the text
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PresentPerfectGameUI.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new PresentPerfectGameUI().setVisible(true);
