...
public class SimplePastGameUI extends AbstractVerbGameUI {

    public SimplePastGameUI() {
        super("German Verb Exercise - Simpe Past Tense");
    }

    @Override
    protected String getCSVFilePath() {
        return "csv/verbsSimplePast.csv";
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SimplePastGameUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new SimplePastGameUI().setVisible(true);
