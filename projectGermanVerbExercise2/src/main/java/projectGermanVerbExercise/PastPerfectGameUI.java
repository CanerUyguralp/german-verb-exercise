...
public class PastPerfectGameUI extends AbstractVerbGameUI {

    public PastPerfectGameUI() {
        super("German Verb Exercise - Past Perfect Tense");
    }

    @Override
    protected String getCSVFilePath() {
        return "csv/verbs_past_perfect.csv";
    }
    ...
    protected void askQuestion() {
        ...
        if (currentPersonIndex < persons.length) {
            ...
            try {
                ...
                doc.insertString(doc.getLength(), "Plusquamperfekt: ", tenseStyle);
                ...
                // Append the rest of the text
                doc.insertString(doc.getLength(), "hatte/war", hilfsVerbStyle);
                //Append the text for Hilfsverb
                //doc.insertString(doc.getLength(), " mit dem passenden Hilfsverb(hatte/war) ", null);
                // Append the rest of the text
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PastPerfectGameUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new PastPerfectGameUI().setVisible(true);
